...
```{r}
name <- c("John", "Jim", "Jenny", "Jake","Jan")
name
```
...
student_lists <- list(student_grades, student_names, student_count)
student_lists
```
...
student_garde_level <- c("Sophomore", "Junior", "Senior")
student_class_grade <- c(65, 82, 91)

df <- data.frame(student_names, student_garde_level, student_class_grade)
df
...
```{r}
student_grades <- df$student_garde_level
student_grades
```
...
```{r}
df$student_subjects <- c("Math", "History", "English")
df
```
...
```{r}
student_names <- c("Jack", "Jerry")
student_garde_level <- c("Freashman", "Senior")
student_class_grade <- c(75, 82)
student_subjects <- c("Math", "English")
...
my_factor <- factor(c("Blue", "Brown", "Green", "Gray", "Blue", "Brown", "Green"))
my_factor
```
...
```{r}
my_factor <- factor(
  c("Blue", "Brown", "Green", "Gray", "Blue", "Brown", "Green"),
  levels <-c("Blue", "Brown", "Green", "Gray")
  )
...
value_5 <- my_array[2, 2, 1]
print(value_5)

#Print the third row of the first matrix.
third_row_matrix1 <- my_array[3, , 1]
print(third_row_matrix1)

#Print the second column of both matrices.
second_column_both_matrices <- my_array[, 2, ]
